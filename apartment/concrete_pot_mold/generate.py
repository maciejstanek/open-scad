...
parser.add_argument('--component', type=str, default="mold", help="Component to select ('mold', 'vase', 'lock')")
...
generate_main_shape()
scale_factor = (args.diameter + 2*args.wall) / args.diameter
...
print("    translate([{0:.2f}, {1:.2f}, 0]) {{".format(args.wall, mold_hold_distance - 2*args.wall))
print("      cube([{0:.2f}, {1:.2f}, {2:.2f}]);".format(args.wall, args.wall, args.height))
print("    }")
print("  }")
print("}")
print("")
...
print("module mold_clip() {")
print("  difference() {")
print("    translate([-3*{0:.2f}, -3*{0:.2f}, 0]) {{".format(args.wall))
print("      cube([6*{0:.2f}, 4*{0:.2f}, {1:.2f}]);".format(args.wall, args.height))
print("    }")
print("    translate([0, -{0:.2f}, 0]) {{".format(mold_hold_distance))
print("      generate_mold_side();")
print("      mirror([1, 0, 0]) {")
