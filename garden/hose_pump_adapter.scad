module adapter_template(pipe_inner_diameter, outlet_outer_diameter, wall_thickness, slope_length, section_length) {
	polygon([
		...
		[pipe_inner_diameter / 2, 2 * section_length + slope_length],
		[pipe_inner_diameter / 2 + wall_thickness, 2 * section_length + slope_length - wall_thickness],
...
color("white") rotate_extrude($fn = 100) adapter_template(4.3, 7.3, 1, 3, 6);
